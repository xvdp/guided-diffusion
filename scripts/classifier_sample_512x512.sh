...
CLASSIFIER='../models/512x512_classifier.pt'
DIFFUSION='../models/512x512_diffusion.pt'
...
python classifier_sample.py $MODEL_FLAGS --classifier_scale 4.0 --classifier_path $CLASSIFIER --model_path $DIFFUSION $SAMPLE_FLAGS
